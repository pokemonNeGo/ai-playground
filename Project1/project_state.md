...
## 📅 Прогресс выполнения
Нумерация лабораторных: первая цифра = номер проекта. Все лабы Project1 имеют вид 1.x; лабы следующего проекта будут 2.x в этом же репозитории.
...
*(Номера разделов архитектурных решений не связаны с номерами лабораторных.)*
...
ai-playground/
 ...
 │
 └── Project1/                   # Основной проект 1 (лабы 1.1–1.15)
